...
{
var  anim="<font size='7' style='font-family:Kristen ITC;'>The character you choose: <img src='animation/ch1.png' width='100' height='100' /></font>"
style.innerHTML=anim;
anim="<br>"
style.innerHTML+=anim;
anim="<img src='imag/marble3.png'> &nbsp &nbsp "
style.innerHTML+=anim;
anim="<img src='imag/marble1.png' > &nbsp &nbsp "
style.innerHTML+=anim;
anim="<img src='imag/marble1.png' > &nbsp &nbsp "
style.innerHTML+=anim;
...
var gamearray=['pic1.PNG','pic1.PNG','pic2.jpg','pic2.jpg','pic3.png','pic3.png','pic4.jpg','pic4.jpg','pic5.jpg','pic5.jpg','pic6.jpg','pic6.jpg','pic7.jpg','pic7.jpg','pic10.PNG','pic10.PNG'];
var sel_array=[];
...
counter_id=setInterval(function()
{
	...
	{  
		...
		var string="<img  src='imag/Time_Out_logo.png' width='700' heigh='500' >,<img  src='imag/Crying.gif' width='100' heigh='100' >"
	...
	for(var j=0;j<4;j++)
		{
			...
			image.setAttribute('src',"animation/" + bic_array[index]);
	...
	{	
		...
		if(sel_array.length==1)
			{	
				...
				image1.setAttribute('src',"animation/" + array[x1]);
		...
		if(sel_array.length==2)
		{
			...
			image2.setAttribute('src',"animation/" + array[x2]);
		...
		{			
			...
			if(array[x1]==array[x2]&&x1!=x2)
			{
				...
				if(scr==8&&counter<=90)
				{
					...
					game.innerHTML+=string;
					var next="<button id='next'><img src='imag/NEXT (2).gif' width=90 height=70></button>"
					game.innerHTML+=next;
...
anim="<img src='imag/marble1.png' > &nbsp &nbsp "
style.innerHTML+=anim;
anim="<p  style='font-family:Kristen ITC; text-align: center; font-size: 20pt;'>level 2</p>"
style.innerHTML+=anim;
anim="<button id='level1'><img src='imag/level11.PNG' ></button>"
game.innerHTML=anim;
anim="<br>"
...
game.appendChild(new_line);
game.appendChild(table);
var gamearray=['pic1.PNG','pic1.PNG','pic2.jpg','pic2.jpg','pic3.png','pic3.png','pic4.jpg','pic4.jpg','pic5.jpg','pic5.jpg','pic6.jpg','pic6.jpg','pic7.jpg','pic7.jpg','pic10.PNG','pic10.PNG','pic11.jpg','pic11.jpg','pic12.jpg','pic12.jpg'];
var sel_array=[];
var start_btn=document.getElementById('start');
var column1;
var column2;
...
anim="<img src='imag/marble3.png' > &nbsp &nbsp "
style.innerHTML+=anim;
anim="<p  style='font-family:Kristen ITC; text-align: center; font-size: 20pt;'>level 3</p>"
style.innerHTML+=anim;
anim="<button id='level1'><img src='imag/level11.PNG' ></button>"
game.innerHTML=anim;
anim="<br>"
...
game.appendChild(new_line);
game.appendChild(table);
var gamearray=['pic1.PNG','pic1.PNG','pic2.jpg','pic2.jpg','pic3.png','pic3.png','pic4.jpg','pic4.jpg','pic5.jpg','pic5.jpg','pic6.jpg','pic6.jpg','pic7.jpg','pic7.jpg','pic10.PNG','pic10.PNG','pic11.jpg','pic11.jpg','pic12.jpg','pic12.jpg','pic15.jpg','pic15.jpg','pic19.jpg','pic19.jpg'];
var sel_array=[];
var start_btn=document.getElementById('start');
var column1;
var column2;
	...
	function image_btn_click(e)
	{
		...
		{			
			...
			if(array[x1]==array[x2]&&x1!=x2)
			{
				...
				{
					clearInterval(counter_id);
					var string="<img  src='imag/Time_Out_logo.png' width='50' heigh='450' >,<img  src='imag/Crying.gif' width='100' heigh='100' >"
					game.innerHTML=string;
					var retry="<button id='re'><img src='imag/re-try-hi.png' width=70 height=70></button>"
					game.innerHTML+=retry;
					retry=document.getElementById('re');
